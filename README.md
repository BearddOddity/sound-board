...
Trigger sound effects and clips during your stream
...
- `streamersuite-integration` — the StreamerSuite-adapted version (shared theme/settings, and shared backend where applicable). Not independently buildable; it's the staging copy for what's vendored into StreamerSuite's `src/apps/sound-board/`.
